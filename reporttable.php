...
$sql = "SELECT BOOKER, NAME, FLOOR, ROOM_BOOKED, START_DATE, END_DATE, START_TIME, END_TIME, BOOKING_ID, STATUS ";
$sql.=" FROM bookings ";
$query=mysqli_query($conn, $sql) or die("reporttable.php: get bookings");
