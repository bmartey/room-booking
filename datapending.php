...
$sql = "SELECT BOOKER, NAME, FLOOR, EMAIL, ITEMS_NEEDED, ROOM_BOOKED, START_DATE, END_DATE, START_TIME, END_TIME, BOOKING_ID ";
$sql.=" FROM bookings WHERE STATUS = 'PENDING'";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = "<a href='#' class='button round alert' name='disapprove' value='{$row['BOOKING_ID']}' onclick='disapprovenotification({$row['BOOKING_ID']})' type='submit' id='disapprove' >Deny</a>";
